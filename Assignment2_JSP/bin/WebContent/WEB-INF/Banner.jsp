...
<body>
			...
			<li>
				<div class="btn-group">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="EnterDepartment.jsp">Enter
							Department</a>
						<div class="dropdown-divider">
							<a class="dropdown-item" href="ViewDepartments.jsp">View
								Department</a>
						</div>
			...
			<li>
				<div class="btn-group">
					<button type="button" class="btn btn-lg btn-danger dropdown-toggle"
						...
						Employees</button>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="EnterEmployee.jsp">Enter
							Employee</a>
						<div class="dropdown-divider">
							<a class="dropdown-item" href="ViewEmployee.jsp">View
								Employee</a>
						</div>
					</div>
				</div>
	...
	<li class="pull-right">Logged in as <%= ckF.findCookie(cookies) %>
